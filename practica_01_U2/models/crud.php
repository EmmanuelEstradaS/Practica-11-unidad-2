...
public static function registroUsuarioModel($datosModel, $tabla)
	{
		...
		$stmt->bindParam(":name", $datosModel["username"], PDO::PARAM_STR);
...
#####################################################################################
	...
	public static function vistaProblemasModel($tabla)
	{
			$stmt = Conexion::conectar()->prepare("SELECT * FROM $tabla"); 
			if($stmt->execute())
			{
	...
	public static function registroProblemaModel($datosModel, $tabla)
	{
		$stmt = Conexion::conectar()->prepare("INSERT INTO $tabla (nombre) VALUES (:nombre)");	
		$stmt->bindParam(":nombre", $datosModel["nombre"], PDO::PARAM_STR);
		if($stmt->execute())
	...
	public static function getAlumnosTutorModel($tabla,$idCarrera)
	{
 	...
 	public static function editarProblemaModel($idCarrera,$tabla)
 	{
 		$stm = Conexion::conectar()->prepare("SELECT * FROM $tabla WHERE id_tipo_problema = :id_tipo_problema");
 		$stm->bindParam(":id_tipo_problema", $idTipoProblema, PDO::PARAM_INT);
 		$stm->execute();
 		return $stm->fetch();
 		$stm->close();
 	}
	...
	public static function actualizarProblemaModel($datosModel, $tabla)
	{
		$stmt = Conexion::conectar()->prepare("UPDATE $tabla SET nombre = :nombre WHERE id_tipo_problema = :id_tipo_problema");	
		$stmt->bindParam(":nombre", $datosModel["nombre"], PDO::PARAM_STR);
		$stmt->bindParam(":id_tipo_problema", $datosModel["id_tipo_problema"], PDO::PARAM_INT);
		if($stmt->execute())
		{
	...
	public static function borrarProblemaModel($datosModel, $tabla)
	{
		$stmt = Conexion::conectar()->prepare("DELETE FROM $tabla WHERE id_tipo_problema = :id_tipo_problema");	
		$stmt->bindParam(":id_tipo_problema", $datosModel, PDO::PARAM_INT);
		if($stmt->execute())
		{
			return "success";
		}
